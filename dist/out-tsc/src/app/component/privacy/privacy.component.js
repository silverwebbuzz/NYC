...
var PrivacyComponent = /** @class */ (function () {
    function PrivacyComponent(navCtrl, modalCtrl, toastController, storage, auth, navParams) {
        ...
        // testObject : any;
        this.networkType = 'wp-json/my-route/v1/reactions';
        this.items = [];
    ...
    PrivacyComponent.prototype.goToBack = function () {
    ...
    PrivacyComponent.prototype.edit = function (info) {
